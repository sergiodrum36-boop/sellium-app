...
exports.calcularConsumoAcuerdo = calcularConsumoAcuerdo;
exports.calcularEstadoVigencia = calcularEstadoVigencia;
exports.diasHastaFin = diasHastaFin;
exports.estaDentroDeVigencia = estaDentroDeVigencia;
exports.fechaEfectivaMovimiento = fechaEfectivaMovimiento;
...
function fechaEfectivaMovimiento(mv) {
...
function estaDentroDeVigencia(fechaEfectiva, inicio, fin) {
...
function calcularConsumoAcuerdo({
  acuerdo,
  movimientos
}) {
  ...
  (movimientos || []).forEach(mv => {
    ...
    if (!acc) {
      acc = {
        id_marca: mv.id_marca,
        nombre_marca: mv.nombre_marca || mv.id_marca,
        uds: 0
      };
...
function calcularEstadoVigencia(acuerdo, hoy = new Date()) {
...
function diasHastaFin(acuerdo, hoy = new Date()) {
