 ...
 *
 * Fase 2 (pendiente, no en esta versión): generar el PDF del acuerdo con el
 * mismo formato que las propuestas reales de Sergio (cabecera + tabla +
 * condiciones) — se hará después de validar que el dato se captura y el
 * seguimiento calcula bien.
 *
...
import { Plus, Trash2, Handshake, Pencil, X, Eye } from 'lucide-react';
import {
