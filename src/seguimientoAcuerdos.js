...
// Siguiente número de propuesta "NNN/AÑO" (27/07/2026, a petición de
// Sergio: "el número de propuesta debe salir solo... según se van haciendo
// acuerdos va sumando" — en sus 6 ejemplos reales el número era manual y
// tres acuerdos distintos se quedaron con el mismo "315/2026" por error de
// copiar/pegar). Busca el número más alto YA USADO en `anio` (ignora
// acuerdos de otros años o con `numero` vacío/mal formado) y devuelve el
// siguiente, con 3 dígitos con ceros a la izquierda (crece sin problema más
// allá de 999 si hiciera falta).
