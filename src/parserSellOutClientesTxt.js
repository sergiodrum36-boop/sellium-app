 ...
 *
 * y así con cada artículo, repitiendo la cabecera de página cada vez (la
 * línea "PERIODO LIQUIDACION" y la de cabecera de columnas se repiten una
 * vez por cada uno de los bloques de artículo — hay que reconocerlas e
 * ignorarlas TODAS las veces que aparecen, no solo la primera).
 *
 ...
 *
 * Nota sobre codificación: el archivo original de ejemplo exporta algunas
 * letras con tilde/eñe como un espacio en blanco literal (p.ej. "ALBARIÑO"
 * llega como "ALBARI O") — es una limitación del informe de origen (charset
 * antiguo tipo AS/400), no un fallo de este parser; no se intenta corregir.
 *
