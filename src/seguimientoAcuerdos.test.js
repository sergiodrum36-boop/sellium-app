import {
  ...
  diasHastaFin,
  calcularSiguienteNumeroPropuesta,
...
describe('calcularSiguienteNumeroPropuesta', () => {
  test('001 del año cuando no hay ningún acuerdo todavía', () => {
    expect(calcularSiguienteNumeroPropuesta([], 2026)).toBe('001/2026');
  });
  test('sigue la secuencia del año, ignorando otros años', () => {
    const acuerdos = [
      { numero: '001/2026' }, { numero: '002/2026' }, { numero: '005/2025' },
    ];
    expect(calcularSiguienteNumeroPropuesta(acuerdos, 2026)).toBe('003/2026');
    expect(calcularSiguienteNumeroPropuesta(acuerdos, 2025)).toBe('006/2025');
  });
  test('ignora números vacíos o mal formados sin romper', () => {
    const acuerdos = [{ numero: '' }, { numero: 'sin numero' }, { numero: '007/2026' }];
    expect(calcularSiguienteNumeroPropuesta(acuerdos, 2026)).toBe('008/2026');
  });
  test('crece más allá de 999 sin truncar', () => {
    expect(calcularSiguienteNumeroPropuesta([{ numero: '999/2026' }], 2026)).toBe('1000/2026');
  });
});
